						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									<img src="{{ asset('das_css/img/avatars/avatar-4.jpg')}}" alt="Christina Mason" class="img-fluid rounded-circle mb-2" width="128" height="128" />
						...
						<div class="col-md-8 col-xl-9">
							<div class="card">
								...
								<div class="card-body h-100">
									...
									<div class="media">
										<img src="{{ asset('das_css/img/avatars/avatar-5.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Vanessa Tucker">
									...
									<hr />
									<div class="media">
										<img src="{{ asset('das_css/img/avatars/avatar.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Charles Hall">
										<div class="media-body">
									...
									<hr />
									<div class="media">
										<img src="{{ asset('das_css/img/avatars/avatar-4.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="Christina Mason">
										<div class="media-body">
									...
									<hr />
									<div class="media">
										<img src="{{ asset('das_css/img/avatars/avatar-2.jpg')}}" width="36" height="36" class="rounded-circle mr-2" alt="William Harris">
										<div class="media-body">
											...
											<div class="row no-gutters mt-1">
												<div class="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src="{{ asset('das_css/img/photos/unsplash-1.jpg')}}" class="img-fluid pr-2" alt="Unsplash">
												</div>
												<div class="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src="{{ asset('das_css/img/photos/unsplash-2.jpg')}}" class="img-fluid pr-2" alt="Unsplash">
												</div>
											</div>
